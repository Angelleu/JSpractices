const firstName ='Angelbabe';
const lastName ='Leu';
const charsDiff =firstName.length-lastName.length;
...
console.log(`The caracter difference between my first name and last name is ${charsDiff}`);
